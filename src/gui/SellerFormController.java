...
public class SellerFormController implements Initializable {
	...
	public void setServices(SellerService sllService, DepartmentServices dpService) {
		this.service = sllService;
	...
	public void updateFormData() {
		if (entity == null) {
			throw new IllegalStateException("The department is null!");
		} else {
	...
	public void loadAssociatedObjects() {
		if (departmentService == null) {
			throw new IllegalStateException("The department service is null");
		}
